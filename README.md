...
Apple clients use CoreBluetooth and call the C bridge in `src/bridge/smartfin_c_api.h`. See [docs/SWIFT_INTEGRATION.md](docs/SWIFT_INTEGRATION.md) for Xcode linking notes and a minimal Swift example.
