...
#ifndef SF_RECEIVER_BLE_CONFIG_HPP
#define SF_RECEIVER_BLE_CONFIG_HPP
...
constexpr const char* SERVICE_UUID   = "a86d7b16-dd6c-434b-a7ee-f0ca33ac614c"; ///< Primary GATT service
constexpr const char* TELEMETRY_UUID = "deeddb00-166e-407c-8158-7b9693ad2685"; ///< Telemetry NOTIFY characteristic
constexpr const char* CONTROL_UUID   = "c39513e6-631e-439a-9b3b-affa0635b3d1"; ///< Control WRITE_WO_RSP characteristic
...
#endif // SF_RECEIVER_BLE_CONFIG_HPP
