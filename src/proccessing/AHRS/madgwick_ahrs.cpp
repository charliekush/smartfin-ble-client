...
namespace sf::ahrs
{
    ...
    Output AHRS::update(const Sample &sample)
    {
        ...
        const Scalar dt_s = static_cast<Scalar>(
                                sample.elapsed_time_ms - state_.previous_time_ms) *
                            MS_TO_S;
        state_.previous_time_ms = sample.elapsed_time_ms;
    ...
    math3d::Vec3 AHRS::updateGyroBias(
        math3d::Vec3 gyro_rad_s, Scalar dt_s, bool &bias_updated)
    {
    ...
    math3d::Vec3 AHRS::rejectMagneticDistortion(
        math3d::Vec3 mag_uT, bool &mag_used) const
    {
    ...
    math3d::Vec3 AHRS::rejectLinearAcceleration(
        math3d::Vec3 accel_g, Scalar dt_s, bool &accel_used)
    {
    ...
    math3d::Vec3 AHRS::computeAccelError(
        math3d::Quaternion q_hat, math3d::Vec3 accel_used_g) const
    {
    ...
    void AHRS::updateAccelerations(math3d::Vec3 raw_accel_g)
    {
        ...
        const math3d::Quaternion rotated =
            state_.q *
            math3d::Quaternion::pure(state_.accel_zero_g) *
